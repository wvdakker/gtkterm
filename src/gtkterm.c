...
static GType gtkterm_get_type (void);
...
static GType gtkterm_window_get_type (void);
...
static void create_window (GApplication *app)
{
  ...
  window = (GtkTermWindow *)g_object_new (gtkterm_window_get_type (),
                                                  "application", app,
                                                  "show-menubar", TRUE,
                                                  NULL);
  ...
  gtk_scrolled_window_set_child((GtkScrolledWindow *)scroll_window, display);
...
static void gtkterm_window_class_init (GtkTermWindowClass *class)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/com/github/jeija/gtkterm/config_terminal_dialog.ui");
  ...
  gtk_widget_class_bind_template_child (widget_class, GtkTermWindow, buffer);
...
int main (int argc, char *argv[])
{
  ...
  app = GTK_APPLICATION (g_object_new (gtkterm_get_type (),
                                       "application-id", "com.github.jeija.gtkterm",
